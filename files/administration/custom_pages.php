...
if (isset($_POST['save'])) {
	...
	$result = dbquery("DELETE FROM ".DB_COMMENTS." WHERE comment_type='C' AND comment_item_id='".$_POST['page_id']."'");
	$result = dbquery("DELETE FROM ".DB_RATINGS." WHERE rating_type='C' AND rating_item_id='".$_POST['page_id']."'");
