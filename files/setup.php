...
if (isset($_POST['step']) && $_POST['step'] == "3") {
	...
	$pdo_enabled = (isset($_POST['pdo_enabled']) ? stripinput(trim($_POST['pdo_enabled'])) : "");//neu für pdo
...
if (isset($_POST['step']) && $_POST['step'] == "6") {
	...
	if ($error == "") {
		if ($rows == 0) {
			...
			$result = dbquery("INSERT INTO ".$db_prefix."settings (settings_name, settings_value) VALUES ('version', '7.02.07 Projekt PHP7')");
